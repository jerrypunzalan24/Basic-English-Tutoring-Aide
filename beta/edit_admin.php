	  ...
	  <div class="row">
		<div class="col-md-8">
		    <div class="card">
			  ...
			  $isAdmin ='';
			  $about = '';
			  $sql = "SELECT username, password, fname, lname, admin, about FROM accounts WHERE id = $id";
				...
				<form method = 'post' data-toggle = 'validator'>
				    ...
				    <div class="row">
					  <div class="col-md-12">
						<div class="form-group">
						    <label>About</label>
						    <textarea name = 'about' class ='form-control' rows = '5'><?php echo isset($about)? $about: ''; ?></textarea>
						    <div class="help-block with-errors"></div>
						</div>
					  </div>
				    </div>
